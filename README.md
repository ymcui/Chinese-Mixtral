...
在llama.cpp下，测试了Chinese-Mixtral量化版模型的性能，其中包括：

- 模型大小（GB）
- PPL（困惑度）：以4K上下文测量，数值越低越好
- 生成速度：提供了Apple M3 Max以及NVIDIA A100（40G）的生成速度（单位ms/tok），数值越低越好

|              |  F16 | Q8_0 | Q6_K | Q5_K | Q5_0 | Q4_K | Q4_0 | Q3_K | Q2_K |
| ------------ | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Size (GB)    | 87.0 | 46.2 | 35.7 | 30.0 | 30.0 | 24.6 | 24.6 | 19.0 | 14.6 |
| PPL          |      |      |      |      |      |      |      |      |      |
| M3 Max Speed |  OOM |  OOM | 36.0 | 36.9 | 35.7 | 31.2 | 27.8 | 37.6 | 29.1 |
| A100 Speed   |  OOM |  OOM | 23.2 |    ? |    ? | 19.2 | 16.9 |    ? | 18.6 |
